            ...
            <div class="card-body">
                ...
                <form action="{{ route('siswa.store') }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input name="nama_siswa" type="text" class="form-control" id="inputNama">
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="inputNip" class="col-sm-2 col-form-label">NIS</label>
                        <div class="col-sm-10">
                            <input name="nis" type="number" class="form-control" id="inputNip">
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="inputNip" class="col-sm-2 col-form-label">Kelas</label>
                        <div class="col-sm-10">
                            <input name="kelas" type="text" class="form-control" id="inputNip">
                        </div>
                    </div>
